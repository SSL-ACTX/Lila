...
pub use signature::{build_cranelift_signature, get_field_info, get_flattened_types};
pub use storage::{
...
fn lower_instruction_internal<M: Module>(
    ...
    match &inst.kind {
        ...
        InstructionKind::MatMult(dest, lhs, rhs) => {
            ...
            sig.params
                .push(cranelift::prelude::AbiParam::new(types::I64)); // a
            sig.params
                .push(cranelift::prelude::AbiParam::new(types::I64)); // b
            sig.params
                .push(cranelift::prelude::AbiParam::new(types::I64)); // m
            sig.params
                .push(cranelift::prelude::AbiParam::new(types::I64)); // n
            sig.params
                .push(cranelift::prelude::AbiParam::new(types::I64)); // k
            sig.returns
                .push(cranelift::prelude::AbiParam::new(types::I64)); // c

            let callee = ctx.module.declare_function(
            ...
            let call = ctx
                .builder
                .ins()
                .call(local_callee, &[a_ptr, b_ptr, m, n, k]);
